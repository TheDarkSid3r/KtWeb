const ModuleComponents = [
    {
        ...
        create: function (module, selects, get, debug) {
            ...
            var texts = ["BigButton/rule_abort", "BigButton/rule_hold", "BigButton/rule_press", "BigButton/rule_detonate"];
            ...
            get(".button-text").html(LocalizationManager.GetTerm(texts[text]).toUpperCase());
        }
    },
    {
        id: "SimpleButton",
    ...
    },
    {
        ...
        create: function (module, selects, get, debug) {
            ...
            var setDisplay = (h) => {
                get("[data-wof-text=display]").html(h ? "" : LocalizationManager.GetTerm("WhosOnFirst/rule_" + currentDisplay).replace("---", ""));
                currentButtons.forEach((b, i) => {
                    get("[data-wof-text=" + (i + 1) + "]").html(LocalizationManager.GetTerm("WhosOnFirst/rule_" + b));
                });
                if (h) {
                    for (var i = 0; i < 6; i++) {
    ...
    },
    {
        ...
        create: function (module, selects, get, debug) {
            ...
            var w = get("#metadata65").parent().parent();
